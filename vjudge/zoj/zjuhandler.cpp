...
string convertResult(string res) {
	if (res.find("Compilation Error")!=string::npos) return "Compilation Error";
	if (res.find("Time Limit Exceeded")!=string::npos) return "Time Limit Exceeded";
	if (res.find("Memory Limit Exceeded")!=string::npos) return "Memory Limit Exceeded";
	if (res.find("Floating Point Error")!=string::npos) return "Runtime Error";
	if (res.find("Output Limit Exceeded")!=string::npos) return "Output Limit Exceeded";
